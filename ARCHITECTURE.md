...
- **Dynamic Alpha Normalization con Relaxed Constraint**: Il gradiente RL è bilanciato dalla formula $\alpha = \frac{\lambda}{\frac{1}{N} \sum |Q|}$ con $\lambda = 2.5$ fisso per invarianza allo scale del Critic. Il vincolo imitativo viene allentato applicando un decadimento esponenziale direttamente alla BC Penalty ($w_{BC}$ da $1.0$ a $0.1$ su 100k step) (Beeson & Montana, 2022).
